...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$data$3a$6a100d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/products/data:6a100d [app-client] (ecmascript) <text/javascript>");
...
function CollectionsPageContent() {
    ...
    const [sortOrder, setSortOrder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(searchParams.get('sort') || 'default');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CollectionsPageContent.useEffect": ()=>{
            ...
            async function fetchInitialProducts() {
                ...
                try {
                    const productsFromSource = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$data$3a$6a100d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getProducts"])();
    ...
    const { minProductPrice: derivedMinPrice, maxProductPrice: derivedMaxPrice } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CollectionsPageContent.useMemo": ()=>{
            ...
            const allParsedNumericPrices = allProducts.map({
                "CollectionsPageContent.useMemo.allParsedNumericPrices": (p)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePrice"])(p.price)
            }["CollectionsPageContent.useMemo.allParsedNumericPrices"]).filter({
                "CollectionsPageContent.useMemo.allParsedNumericPrices": (p)=>!isNaN(p)
            }["CollectionsPageContent.useMemo.allParsedNumericPrices"]);
    ...
    const [priceRange, setPriceRange] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "CollectionsPageContent.useState": ()=>{
    ...
    const filteredProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CollectionsPageContent.useMemo[filteredProducts]": ()=>{
            ...
            if (selectedCategory && selectedCategory !== 'All') {
                productsToFilter = productsToFilter.filter({
                    "CollectionsPageContent.useMemo[filteredProducts]": (p)=>p.category === selectedCategory
                }["CollectionsPageContent.useMemo[filteredProducts]"]);
            }
            productsToFilter = productsToFilter.filter({
                "CollectionsPageContent.useMemo[filteredProducts]": (p)=>{
            ...
            if (searchTerm.trim()) {
                ...
                productsToFilter = productsToFilter.filter({
                    "CollectionsPageContent.useMemo[filteredProducts]": (p)=>p.name.toLowerCase().includes(lowerSearchTerm) || p.description.toLowerCase().includes(lowerSearchTerm) || p.category && p.category.toLowerCase().includes(lowerSearchTerm)
                }["CollectionsPageContent.useMemo[filteredProducts]"]);
            }
            // Apply sorting
            if (sortOrder === 'price-asc') {
                productsToFilter.sort({
                    "CollectionsPageContent.useMemo[filteredProducts]": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePrice"])(a.price) - (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePrice"])(b.price)
                }["CollectionsPageContent.useMemo[filteredProducts]"]);
            } else if (sortOrder === 'price-desc') {
                productsToFilter.sort({
                    "CollectionsPageContent.useMemo[filteredProducts]": (a, b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePrice"])(b.price) - (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePrice"])(a.price)
                }["CollectionsPageContent.useMemo[filteredProducts]"]);
            }
    ...
    const totalPages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CollectionsPageContent.useMemo[totalPages]": ()=>{
    ...
    const paginatedProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CollectionsPageContent.useMemo[paginatedProducts]": ()=>{
                                ...
                                children: [
                                    ...
                                    isLoadingProducts ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                children: searchTerm || selectedCategory || searchParams.get('minPrice') || searchParams.get('maxPrice') || sortOrder !== 'default' ? `Your filters did not match any products.` : "There are no products in this collection yet."
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/collections/page.tsx",
                                                lineNumber: 506,
                                                columnNumber: 17
...
_s(CollectionsPageContent, "IF2lYaCabmCpl9YG4L+cSys8EaU=", false, function() {
    return [
...
//# sourceMappingURL=src_fc1022b4._.js.map