...
console.log("Raw NEXT_PUBLIC_FIREBASE_API_KEY:", ("TURBOPACK compile-time value", "AIzaSyDNgs7v0qj_UdKUkVQ5GWR1SoGM9yy8pjc") || "MISSING/undefined");
console.log("Raw NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN:", ("TURBOPACK compile-time value", "aarambhdecor-efc1f.firebaseapp.com") || "MISSING/undefined");
console.log("Raw NEXT_PUBLIC_FIREBASE_PROJECT_ID:", ("TURBOPACK compile-time value", "aarambhdecor-efc1f") || "MISSING/undefined");
console.log("Raw NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET:", ("TURBOPACK compile-time value", "aarambhdecor-efc1f.appspot.com") || "MISSING/undefined");
console.log("Raw NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID:", ("TURBOPACK compile-time value", "271398567236") || "MISSING/undefined");
console.log("Raw NEXT_PUBLIC_FIREBASE_APP_ID:", ("TURBOPACK compile-time value", "1:271398567236:web:6a0b36e903873336e6eb11") || "MISSING/undefined");
console.log("Raw NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID:", ("TURBOPACK compile-time value", "G-V0L9NYGFGH") || "Not defined (Optional)");
console.log("------------------------------------------------------------------");
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyDNgs7v0qj_UdKUkVQ5GWR1SoGM9yy8pjc"),
    authDomain: ("TURBOPACK compile-time value", "aarambhdecor-efc1f.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "aarambhdecor-efc1f"),
    storageBucket: ("TURBOPACK compile-time value", "aarambhdecor-efc1f.appspot.com"),
    messagingSenderId: ("TURBOPACK compile-time value", "271398567236"),
    appId: ("TURBOPACK compile-time value", "1:271398567236:web:6a0b36e903873336e6eb11"),
    measurementId: ("TURBOPACK compile-time value", "G-V0L9NYGFGH")
};
...
console.log("Environment Type:", ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : "Server");
...
if (!firebaseConfig.apiKey || !firebaseConfig.projectId) {
    console.error("CRITICAL FIREBASE CONFIG ERROR (src/lib/firebase.ts): API Key or Project ID is missing or undefined in the firebaseConfig object. Firebase services will likely be unavailable." + " Please ensure NEXT_PUBLIC_FIREBASE_API_KEY and NEXT_PUBLIC_FIREBASE_PROJECT_ID are correctly set in your .env file at the project root " + "and that the Next.js server has been restarted after changes to .env.");
// app, db, and storage remain null as per their initial declaration.
    ...
    try {
        ...
        storage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getStorage"])(app);
    } catch (e) {
        ...
        if (e.code === 'auth/invalid-api-key' || e.message && e.message.toLowerCase().includes('invalid-api-key')) {
            console.error("Firebase Error (invalid-api-key possibly, or other init error) from src/lib/firebase.ts: This strongly suggests that your NEXT_PUBLIC_FIREBASE_API_KEY " + "is incorrect, missing, or not accessible by the current environment. " + "1. Verify the key in your project's root .env file against your Firebase project settings. " + "2. Ensure the Next.js development server was restarted after any .env changes.");
        }
...
"[project]/src/app/products/actions.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"002ffea14902e42b8dc345f2f6a9b0677ae7612c80":"seedProductsToFirestore","009c0e4f9c36b44a23d3734f13b4298bc7b33dd084":"getProducts","40085e20f65caaa54feef8e67c51686a8fea0476fc":"getProductById","407a6f9917f614e1200275cb077c7f741008f38c04":"getFeaturedProducts"},"",""] */ __turbopack_context__.s({
    "getFeaturedProducts": (()=>getFeaturedProducts),
    "getProductById": (()=>getProductById),
    "getProducts": (()=>getProducts),
    "seedProductsToFirestore": (()=>seedProductsToFirestore)
});
...
async function seedProductsToFirestore() {
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"]) {
        ...
        return {
            success: false,
            message: "Database service is not available. Seeding aborted."
        };
    }
    if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].length === 0) {
        console.warn("seedProductsToFirestore: No mock products found to seed.");
        return {
            success: false,
            message: "No mock products found to seed."
        };
    }
    console.log(`seedProductsToFirestore: Attempting to seed ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].length} products...`);
    const batch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["writeBatch"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"]); // Use db!
    let seededCount = 0;
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].forEach((product)=>{
        const productDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"], 'products', product.id); // Use db!
        const productData = {
            name: product.name,
    ...
    try {
        ...
        return {
            success: true,
            message: `Successfully seeded ${seededCount} products to Firestore.`,
            count: seededCount
        };
    } catch (error) {
        ...
        return {
            success: false,
            message: `Failed to seed products: ${errorMessage}`
        };
    }
}
async function getProducts() {
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"]) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"];
    }
    try {
        console.log('getProducts: Attempting to fetch products from Firestore...');
        const productsColRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"], 'products'); // Use db!
        let productsSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDocs"])(productsColRef);
        if (productsSnap.empty) {
            ...
            if (seedResult.success && seedResult.count && seedResult.count > 0) {
                ...
                productsSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDocs"])(productsColRef); // productsColRef was defined with db!
                if (productsSnap.empty) {
...
async function getProductById(id) {
    ...
    try {
        ...
        const productDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"], 'products', id); // Use db!
        const productSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDoc"])(productDocRef);
        if (productSnap.exists()) {
            ...
            if (quickCheckSnap.empty) {
                ...
                if (seedResult.success && seedResult.count && seedResult.count > 0) {
                    ...
                    const productSnapAfterSeed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDoc"])(productDocRef); // productDocRef defined with db!
...
async function getFeaturedProducts(count) {
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"]) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].filter((p)=>p.featured).slice(0, count);
    }
    try {
        console.log(`getFeaturedProducts: Attempting to fetch ${count} featured products from Firestore...`);
        const productsColRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"], 'products'); // Use db!
        let featuredProductsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["query"])(productsColRef, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["where"])('featured', '==', true), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["limit"])(count));
        let productsSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDocs"])(featuredProductsQuery);
        ...
        if (productsSnap.empty) {
            ...
            const allProductsCheckQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["query"])(productsColRef, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["limit"])(1)); // productsColRef defined with db!
            const anyProductSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDocs"])(allProductsCheckQuery);
            if (anyProductSnap.empty) {
                ...
                if (seedResult.success && seedResult.count && seedResult.count > 0) {
                    ...
                    productsSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDocs"])(featuredProductsQuery); // featuredProductsQuery defined with db!
                    if (productsSnap.empty) {
            ...
            if (productsSnap.empty) {
                ...
                const fallbackQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["query"])(productsColRef, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["orderBy"])('name'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["limit"])(count)); // productsColRef defined with db!
                productsSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDocs"])(fallbackQuery);
                if (productsSnap.empty) {
                    ...
                    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].slice(0, count);
                }
            }
        }
        ...
        if (productsToReturn.length === 0 && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].length > 0) {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(seedProductsToFirestore, "002ffea14902e42b8dc345f2f6a9b0677ae7612c80", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getProducts, "009c0e4f9c36b44a23d3734f13b4298bc7b33dd084", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getProductById, "40085e20f65caaa54feef8e67c51686a8fea0476fc", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getFeaturedProducts, "407a6f9917f614e1200275cb077c7f741008f38c04", null);
}}),
"[project]/.next-internal/server/app/product/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/products/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/actions.ts [app-rsc] (ecmascript)");
;
;
}}),
"[project]/.next-internal/server/app/product/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/products/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$product$2f5b$id$5d2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/product/[id]/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/products/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
}}),
"[project]/.next-internal/server/app/product/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/products/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "009c0e4f9c36b44a23d3734f13b4298bc7b33dd084": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getProducts"]),
    "40085e20f65caaa54feef8e67c51686a8fea0476fc": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getProductById"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/products/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$product$2f5b$id$5d2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/product/[id]/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/products/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
}}),
"[project]/.next-internal/server/app/product/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/products/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "009c0e4f9c36b44a23d3734f13b4298bc7b33dd084": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$product$2f5b$id$5d2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["009c0e4f9c36b44a23d3734f13b4298bc7b33dd084"]),
    "40085e20f65caaa54feef8e67c51686a8fea0476fc": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$product$2f5b$id$5d2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["40085e20f65caaa54feef8e67c51686a8fea0476fc"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$product$2f5b$id$5d2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/product/[id]/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/products/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <module evaluation>');
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$product$2f5b$id$5d2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$products$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/product/[id]/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/products/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <exports>');
}}),
...
"[project]/src/app/product/[id]/page.tsx (client reference/proxy) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2d$edge$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/src/app/product/[id]/page.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/product/[id]/page.tsx <module evaluation>", "default");
}}),
"[project]/src/app/product/[id]/page.tsx (client reference/proxy)": ((__turbopack_context__) => {
"use strict";
...
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2d$edge$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/src/app/product/[id]/page.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/product/[id]/page.tsx", "default");
}}),
...
var { g: global, __dirname } = __turbopack_context__;
{
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$product$2f5b$id$5d2f$page$2e$tsx__$28$client__reference$2f$proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/app/product/[id]/page.tsx (client reference/proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$product$2f5b$id$5d2f$page$2e$tsx__$28$client__reference$2f$proxy$29$__ = __turbopack_context__.i("[project]/src/app/product/[id]/page.tsx (client reference/proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$product$2f5b$id$5d2f$page$2e$tsx__$28$client__reference$2f$proxy$29$__);
}}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5b4e6bc2._.js.map